                            ...
                            <?php $__currentLoopData = $inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="width:5%"><img style="width:50px"
                                            src="<?php echo e(asset('assets/img/' . $value['product_image'])); ?>"alt=""></td>
                                    ...
                                    <td style="width:5%" class="project-actions text-right">
                                        ...
                                        <form action="inventories/<?php echo e($value->inventory_id); ?>" method="POST"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\khoaluanchuyennganh\code\02_04_2024\TLCN_Laravel\resources\views/admin/inventories/index.blade.php ENDPATH**/ ?>