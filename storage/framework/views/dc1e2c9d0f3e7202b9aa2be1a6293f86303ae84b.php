        ...
        <?php $__currentLoopData = Session::get('Cart')->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="product-widget">
                ...
                <div class="product-body">
                    ...
                    <h4 class="product-price"><span class="qty"><?php echo e($item['quanty']); ?></span><strong> x
                            <?php echo e(number_format($item['price1'])); ?> VND</strong></h4>
                </div>
                <button class="delete">
...
<?php endif; ?>
<?php /**PATH D:\khoaluanchuyennganh\code\02_04_2024\TLCN_Laravel\resources\views/cart-items.blade.php ENDPATH**/ ?>