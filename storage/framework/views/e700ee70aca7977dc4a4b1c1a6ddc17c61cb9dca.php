                                        ...
                                        <?php $__currentLoopData = $listorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="product-coupon" style="width:12%">
                                                    <strong>
                                                        <?php if($item->coupon_discount > 100): ?>
                                                            <?php echo e(number_format(-$item->coupon_discount, 0, ',', '.')); ?>

                                                        <?php else: ?>
                                                            <?php echo e(number_format(-(($item->coupon_discount * ($item->total / (1 - $item->coupon_discount / 100))) / 100), 0, ',', '.')); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\khoaluanchuyennganh\code\02_04_2024\TLCN_Laravel\resources\views/list-order.blade.php ENDPATH**/ ?>