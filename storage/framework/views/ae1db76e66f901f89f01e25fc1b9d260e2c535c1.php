            ...
            <form id="orderForm" action="<?php echo e(route('order')); ?>" method="POST">
                ...
                <div class="col-md-6">
                    <div class="billing-details" style="border-top: 1px solid #ccc">
                        ...
                        <div class="form-group">
                            <input class="input" type="text" id="address" name="address" placeholder="Địa chỉ nhận hàng" value="<?php echo e(Auth::user()->address); ?>" required>
                        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP-LARAVEL-main\resources\views/checkout.blade.php ENDPATH**/ ?>