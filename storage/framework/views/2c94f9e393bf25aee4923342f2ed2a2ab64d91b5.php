                ...
                <?php if($cou['min_order'] < Session::get('Cart')->totalPrice): ?>
                    ...
                    <div class="order-col" style="margin-top:12px">
                        ...
                        <div>
                            ...
                            <strong>- <?php echo e(number_format($coupon_amount, 0, ',', '.')); ?> đ</strong>
...
<?php /**PATH D:\khoaluanchuyennganh\code\02_04_2024\TLCN_Laravel\resources\views/couponajax.blade.php ENDPATH**/ ?>