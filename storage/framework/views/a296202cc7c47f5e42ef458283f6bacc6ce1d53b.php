                        ...
                        <div class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <?php if(Session::has('Cart') != null): ?>
                                    <div id="total-quanty-show" class="qty"><?php echo e(Session::get('Cart')->totalQuanty); ?>
                                                ...
                                                <div class="product-widget">
                                                    ...
                                                    <div class="product-body">
                                                        ...
                                                        <h4 class="product-price"><span class="qty">x
                                                                <?php echo e($item['quanty']); ?></span><strong><?php echo e(number_format($item['price'])); ?>VND</strong>
                                                        </h4>
                                                    </div>
                                                    <button class="delete">
                                                        <i class="fa fa-close"
...
<?php /**PATH C:\Users\duyho\Desktop\TLCN_Laravel\resources\views/layout/user.blade.php ENDPATH**/ ?>