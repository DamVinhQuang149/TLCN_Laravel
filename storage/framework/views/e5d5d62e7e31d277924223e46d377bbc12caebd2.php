<body>
                                    ...
                                    <div id="change-item-cart">
                                        <?php if(Session::has('Cart') != null): ?>
                                                    ...
                                                    <div class="product-widget">
                                                        ...
                                                        <div class="product-body">
                                                            ...
                                                            <h4 class="product-price"><span
                                                                    class="qty">x <?php echo e($item['quanty']); ?></span>
                                                                <strong><?php echo e(number_format($item['price'])); ?>VND</strong>
                                                            </h4>
                                                        </div>
                                                        <button class="delete">
                                                            <i class="fa fa-close"
                                                                data-id="<?php echo e($item['productInfo']->id); ?>"></i>
                                                        </button>
                                                    </div>
                                            ...
                                            <div class="cart-summary">
                                                ...
                                                <h5><strong>TỔNG: <?php echo e(number_format(Session::get('Cart')->totalPrice)); ?> VND</strong>
                                                </h5>
                                            </div>
                                        <?php else: ?>
                                            <div class="cart-summary">
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if(auth()->check()): ?>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('favorite.show')); ?>">Yêu thích</a></li>
                    <?php else: ?>
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('login')); ?>">Yêu thích</a></li>
                    <?php endif; ?>
    ...
    <!-- /NAVIGATION -->
<?php /**PATH C:\xampp\htdocs\PHP-LARAVEL-main\resources\views/layout/header.blade.php ENDPATH**/ ?>