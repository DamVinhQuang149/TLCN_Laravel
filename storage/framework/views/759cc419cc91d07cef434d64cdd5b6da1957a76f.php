            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a class="btn btn-sm bg-green" href="manufactures/create">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $manufactures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>#<?php echo e($value->manu_id); ?></td>

                                    <td><?php echo e($value->manu_name); ?></td>



                                    <td class="project-actions text-right" style="width: 5%">

                                        <form action="manufactures/<?php echo e($value->manu_id); ?>/edit" method="POST"
                                        ...
                                        <form action="manufactures/<?php echo e($value->manu_id); ?>" method="POST"
                                            enctype="multipart/form-data">
...
<?php echo $__env->make('layout.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\khoaluanchuyennganh\code\codenew\TLCN_Laravel\resources\views/admin/manufactures/index.blade.php ENDPATH**/ ?>