        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">There are <?php echo e($all->count()); ?> Customer's Emails </h3>
                    ...
                    <table class="table table-striped projects">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center" style="width: 9%">#<?php echo e($value->email_id); ?></td>
                                    <td class="text-center" style="width: 30%"><?php echo e($value->email); ?></td>
...
<?php echo $__env->make('layout.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\khoaluanchuyennganh\code\codenew\TLCN_Laravel\resources\views/admin/emails/index.blade.php ENDPATH**/ ?>