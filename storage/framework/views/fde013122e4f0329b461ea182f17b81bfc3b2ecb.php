...
<!-- HEADER -->
                                        ...
                                        <div class="cart-list">
                                            ...
                                            <div class="product-widget">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h4 class="product-price"><span class="qty">x <?php echo e($item['quanty']); ?></span><strong><?php echo e(number_format($item['price'])); ?>VND</strong>
                                                    </h4>
                                                </div>
                                                <button class="delete">
    ...
    <?php echo $__env->make('layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\khoaluanchuyennganh\code\02_04_2024\TLCN_Laravel\resources\views/layout/user.blade.php ENDPATH**/ ?>