...
<body>
    <div class="invoice">
        ...
        <h2>Mã đơn hàng: <?php echo e($order->order_code); ?></h2>
        ...
        <p><strong>Phí vận chuyển: </strong>
            <?php if($order->total >= 300000): ?>
                0đ
            <?php else: ?>
                <?php echo e(number_format($order->shipping_fee, 0, ',', '.')); ?> đ</strong>
            <?php endif; ?>
        </p>
...
<?php /**PATH D:\khoaluanchuyennganh\code\codenew\TLCN_Laravel\resources\views/invoices/index.blade.php ENDPATH**/ ?>