                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('assets/img/' . $item->product->pro_image)); ?>" alt="">
                                       ...
                                       <div class="product-btns">
                                        <?php if(auth()->check()): ?>
                                            <?php if($item->product->favorited): ?>
                                                <button  class="add-to-wishlist"><a href=<?php echo e(route('favorite', $item->product->id)); ?> class="heart"><i class="fa fa-heart"></i></a><span
                                                    class="tooltipp">Bỏ yêu thích</span></button>
                                            <?php else: ?>
                                                <button class="add-to-wishlist"><a href=<?php echo e(route('favorite', $item->product->id)); ?>><i class="fa fa-heart-o"></i></a><span
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\duyho\Desktop\TLCN_Laravel\resources\views/favorites.blade.php ENDPATH**/ ?>