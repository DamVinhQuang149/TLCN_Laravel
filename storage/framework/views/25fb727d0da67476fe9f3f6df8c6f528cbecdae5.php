                                                    ...
                                                    <div id="list-comment">
                                                        <?php if($comments): ?>
                                                            <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($comm->isApproved == 1 && $comm->reply_to_comment_id == ''): ?>
                                                                    <div class="media">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <?php $__currentLoopData = $allcomment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php if($comm->comm_id == $item->reply_to_comment_id): ?>
                                                                                    <div class="media">
                                                                                        <a class="pull-left"
                                                                                            href="#">
                                                                                            <img style="border-radius: 50%;"
                                                                                        ...
                                                                                        <h4 class="media-heading">
                                                                                            <?php echo e($item->user->First_name); ?>

                                                                                            <?php echo e($item->user->Last_name); ?>

                                                                                            <small><?php echo e($item->created_at->format('d/m/Y')); ?></small>

                                                                                        </h4>
                                                                                        <p><?php echo e($item->comment); ?></p>
                                                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('my-comment', $item)): ?>
                                                                                            <!-- <form action="" method="get" class="text-right">
                                                                                                                                                                <a href="" class="btn btn-primary btn-sm">Sửa</a>
                                                                                                                                                            </form> -->
                                                                                            <form class="text-right">
                                                                                                <button type="button"
                                                                                                    id="applyCouponButton"
                                                                                                    style="background-color: #f80808; color: #fff; border: none; border-radius: 4px; padding: 9px; cursor: pointer;"
                                                                                                    onclick="deleteComment(<?php echo e($item->comm_id); ?>)">
                                                                                                    <strong>
                                                                                                        Xóa
                                                                                                    </strong>
                                                                                                </button>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\khoaluanchuyennganh\code\codenew\TLCN_Laravel\resources\views/detail-product.blade.php ENDPATH**/ ?>