                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <img src="{{ asset('assets/img/' . $probyid['pro_image']) }}" alt="" width="70%">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <h2 class="product-name">Tên sản phẩm: {{ $probyid['name'] }}</h2>
                                    <ins class="product-inner-price">Loại sản phẩm: {{ $probyid['type_name'] }}</ins> <br>
                                    <ins class="product-inner-price">Nhà sản xuất: {{ $probyid['manu_name'] }}</ins>
                                    <div class="product-inner-price">
                                        @if($probyid->discount_price > 0)
                                            <ins>{{ number_format($probyid['discount_price']) }} VND</ins>                                         
                                        @else
                                            <ins>{{ number_format($probyid['price']) }} VND</ins> 
                                        @endif
                                        
                                    </div>
                                    <div class="product-inner-price">
                                        <div class="quantity">
                                            <input id="quanty-item-{{ $probyid->id }}" type="number" class="input-text qty text" title="Qty"
                                                probyid="1" size="1" name="quantity" min="1" step="1" value="1">
                                        </div>
                                        <button onclick="AddQuantyCart({{ $probyid->id }})" type="submit" name="submit">thêm vào giỏ</button>
                                    </div>
