...
<div class="my-slide-haha">
    ...
    <div class="slideshow-container-slide">
        ...
        <div class="mySlides-slide fade-slide">
            ...
            <img src="{{ asset('assets/img/slide1.jpg') }}" style="width:100%">
        </div>

        <div class="mySlides-slide fade-slide">
            <div class="numbertext-slide"></div>
            <img src="{{ asset('assets/img/slide2.jpg') }}" style="width:100%">
        </div>
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img style="width=100px" src="{{ asset('assets/img/' . $value['pro_image']) }}" alt="">
                                    ...
                                    <div class="product-body">
                                        ...
                                        @if($value['discount_price'] > 0)
                                            ...
                                            <h4 class="discount-price">
                                                {{ number_format($value->discount_price) }} VND
                                            </h4>                                            
                                        @else
                                            <h4 class="discount-price">
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h4 class="product-price">
                                            <?php echo number_format($value['discount_price']) ?>VND</h4>
                                        <div class="product-rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="product-widget">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name">
                                            <a href="{{ route('detail.product', ['type_id' => $value->type_id, 'id' => $value->id]) }}">
                                                {{ $value->name }}
                                            </a>
                                        </h3>
                                        @if($value->discount_price > 0)
