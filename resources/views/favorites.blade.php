                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    <div class="product-img">
                                        <img src="{{ asset('assets/img/' . $item->product->pro_image) }}" alt="">
                                       ...
                                       <div class="product-btns">
                                        @if (auth()->check())
                                            @if ($item->product->favorited)
                                                <button  class="add-to-wishlist"><a href={{ route('favorite', $item->product->id) }} class="heart"><i class="fa fa-heart"></i></a><span
                                                    class="tooltipp">Bỏ yêu thích</span></button>
                                            @else
                                                <button class="add-to-wishlist"><a href={{ route('favorite', $item->product->id) }}><i class="fa fa-heart-o"></i></a><span
